// WORKING WITH DATA IN THE FORM OF A CLASS RATHER THAN A MAP
// DATA ORGANIZATION AND DESERIALIZATION
...
class Topic {
  ...
  Topic({ required this.id, required this.title, required this.description, required this.img, required this.quizzes });
